...
public class ParkingSystemControllers {
	...
	public ResponseEntity<List<Slot>> getAmtVehicle()
	{
	 Optional<List<Slot>> opListSlots = this.parkingLotService.getSlots();
         return new ResponseEntity<List<Slot>>(optListSlots.get(), HttpStatus.OK);
    }
